...
<body>
    <div style="width: 100%;">
        <h2 style="text-align: center; text-decoration-line: underline; text-transform: uppercase;">Payslip for the month of 10 2018</h2>
        <table border="0" width="100%" align="left" cellspacing="0" cellpadding="5" style="font-size: 19px; margin-bottom: 30px;">
            <tr>
                ...
                <td style="text-align: right;">
                    <p style="font-size: 30px; text-transform: uppercase; margin-bottom: 0px;">Payslip #15059</p>
                    <span>Salary Month : 10,2018</span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" cellspacing="0" cellpadding="5" style="margin: 30px 0px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: right; border: 1px solid #bbb; border-left: none;"><span>0</span></td>
                </tr>
                <tr>
        ...
        <table border="0" width="45%" align="right" cellspacing="0" cellpadding="5">
            <tr>
                <td style="border: none;">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5" style="margin: 100px 0px 50px;">
            <tr>
                <td style="border: none;">
