                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="avatar">
                                        <?php echo substr($list['e_login_name'],0,1);?></a>
                                    <h2><a href="#">
                                            <?php echo $list['e_login_name'];?><span>
                                                <?php echo $list['role'];?></span></a></h2>
                                </td>
                                <td>
                                    <?php echo $list['e_emplouee_id'];?>
                                </td>
                                <td>
                                    <?php echo $list['e_email_work'];?>
                                </td>
                                <td>
                                    <?php echo $list['e_mobile_personal'];?>
                                </td>
                                <td>
                                    <?php echo $list['e_join_date'];?>
                                </td>
                                <td>
                                    <?php echo $list['role'];?>
                                </td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right action-icons">
                                            <li><a href="<?php echo base_url('employee/viewemployee/'.base64_encode($list['e_id'])); ?>" data-toggle="tooltip" title="View"><i class="btn btn-primary fa fa-eye m-r-5"></i></a></li>
